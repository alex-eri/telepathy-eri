...
class MediaStreamHandler(dbus.service.Object):
    ...
    @dbus.service.method('org.freedesktop.Telepathy.Media.StreamHandler', in_signature='a{u(ua(sss))}', out_signature='')
    def SupportedFeedbackMessages(self, Messages):
        """
    ...
    @dbus.service.method('org.freedesktop.Telepathy.Media.StreamHandler', in_signature='a(uuss)', out_signature='')
    def SupportedHeaderExtensions(self, Header_Extensions):
        """
    ...
    @dbus.service.signal('org.freedesktop.Telepathy.Media.StreamHandler', signature='a{u(ua(sss))}')
    def SetRemoteFeedbackMessages(self, Messages):
        """
        Signal emitted when the connection manager wishes to inform the
    ...
    @dbus.service.signal('org.freedesktop.Telepathy.Media.StreamHandler', signature='a(uuss)')
    def SetRemoteHeaderExtensions(self, Header_Extensions):
        """
        Signal emitted when the connection manager wishes to inform the
