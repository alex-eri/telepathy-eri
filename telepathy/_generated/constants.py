# -*- coding: utf-8 -*-
"""List of constants, generated from the Telepathy spec version 0.27.0.1
...
# Account_Flags (bitfield/set of flags, 0 for none)
ACCOUNT_FLAG_CREDENTIALS_STORED = 1
...
# Contact_Blocking_Capabilities (bitfield/set of flags, 0 for none)
...
LAST_CALL_STATE_CHANGE_REASON = 13
...
LAST_SASL_STATUS = 6
# Captcha_Flags (bitfield/set of flags, 0 for none)
CAPTCHA_FLAGS_REQUIRED = 1


# Captcha_Cancel_Reason
CAPTCHA_CANCEL_REASON_USER_CANCELLED = 0
CAPTCHA_CANCEL_REASON_NOT_SUPPORTED = 1
CAPTCHA_CANCEL_REASON_SERVICE_CONFUSED = 2
LAST_CAPTCHA_CANCEL_REASON = 2
# Captcha_Status
CAPTCHA_STATUS_LOCAL_PENDING = 0
CAPTCHA_STATUS_REMOTE_PENDING = 1
CAPTCHA_STATUS_SUCCEEDED = 2
CAPTCHA_STATUS_TRY_AGAIN = 3
CAPTCHA_STATUS_FAILED = 4
LAST_CAPTCHA_STATUS = 4
# Tube_Channel_State
...
# Local_Mute_State
LOCAL_MUTE_STATE_UNMUTED = 0
LOCAL_MUTE_STATE_MUTED = 1
LOCAL_MUTE_STATE_PENDING_MUTE = 2
LOCAL_MUTE_STATE_PENDING_UNMUTE = 3
LOCAL_MUTE_STATE_PARTIALLY_MUTED = 4
LAST_LOCAL_MUTE_STATE = 4
...
# RTCP_XR_Statistics_Flags (bitfield/set of flags, 0 for none)
RTCP_XR_STATISTICS_FLAGS_LOSS = 1
RTCP_XR_STATISTICS_FLAGS_DUPLICATE = 2
RTCP_XR_STATISTICS_FLAGS_JITTER = 4
RTCP_XR_STATISTICS_FLAGS_TTL = 8
RTCP_XR_STATISTICS_FLAGS_HL = 16


# RCPT_XR_RTT_Mode
RCPT_XR_RTT_MODE_ALL = 0
RCPT_XR_RTT_MODE_SENDER = 1
LAST_RCPT_XR_RTT_MODE = 1
# Stream_Flow_State
STREAM_FLOW_STATE_STOPPED = 0
STREAM_FLOW_STATE_PENDING_START = 1
STREAM_FLOW_STATE_PENDING_STOP = 2
STREAM_FLOW_STATE_STARTED = 3
LAST_STREAM_FLOW_STATE = 3
# Call_Stream_Candidate_Type
CALL_STREAM_CANDIDATE_TYPE_NONE = 0
CALL_STREAM_CANDIDATE_TYPE_HOST = 1
CALL_STREAM_CANDIDATE_TYPE_SERVER_REFLEXIVE = 2
CALL_STREAM_CANDIDATE_TYPE_PEER_REFLEXIVE = 3
CALL_STREAM_CANDIDATE_TYPE_RELAY = 4
CALL_STREAM_CANDIDATE_TYPE_MULTICAST = 5
LAST_CALL_STREAM_CANDIDATE_TYPE = 5
# Stream_Component
STREAM_COMPONENT_UNKNOWN = 0
STREAM_COMPONENT_DATA = 1
STREAM_COMPONENT_CONTROL = 2
LAST_STREAM_COMPONENT = 2
...
STREAM_ENDPOINT_STATE_CONNECTING = 0
STREAM_ENDPOINT_STATE_PROVISIONALLY_CONNECTED = 1
STREAM_ENDPOINT_STATE_FULLY_CONNECTED = 2
STREAM_ENDPOINT_STATE_EXHAUSTED_CANDIDATES = 3
STREAM_ENDPOINT_STATE_FAILED = 4
LAST_STREAM_ENDPOINT_STATE = 4
# Debug_Level
DEBUG_LEVEL_ERROR = 0
