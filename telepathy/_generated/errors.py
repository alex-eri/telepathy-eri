...
class MediaCodecsIncompatible(DBusException):
    """\
    ...
    """
    _dbus_error_name = 'org.freedesktop.Telepathy.Error.Media.CodecsIncompatible'
  
class MediaUnsupportedType(DBusException):
    """\
    ...
    """
    _dbus_error_name = 'org.freedesktop.Telepathy.Error.Media.UnsupportedType'
  
class MediaStreamingError(DBusException):
    """\
    ...
    """
    _dbus_error_name = 'org.freedesktop.Telepathy.Error.Media.StreamingError'
...
class Rejected(DBusException):
    """\
      Raised when an incoming or outgoing Call1 is
...
class SoftwareUpgradeRequired(DBusException):
    """\
      Raised as a
        ConnectionError
    ...
    """
    _dbus_error_name = 'org.freedesktop.Telepathy.Error.SoftwareUpgradeRequired'
  
class EmergencyCallsNotSupported(DBusException):
    """\
    ...
    """
    _dbus_error_name = 'org.freedesktop.Telepathy.Error.EmergencyCallsNotSupported'
  
class InsufficientBalance(DBusException):
    """\
    ...
    """
    _dbus_error_name = 'org.freedesktop.Telepathy.Error.InsufficientBalance'
  
class CaptchaNotSupported(DBusException):
    """\
    ...
    """
    _dbus_error_name = 'org.freedesktop.Telepathy.Error.CaptchaNotSupported'
