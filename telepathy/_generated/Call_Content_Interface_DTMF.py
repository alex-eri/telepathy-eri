...
class CallContentInterfaceDTMF(dbus.service.Interface):
    """\
    ...
    def __init__(self):
        self._interfaces.add('org.freedesktop.Telepathy.Call1.Content.Interface.DTMF')

    @dbus.service.method('org.freedesktop.Telepathy.Call1.Content.Interface.DTMF', in_signature='y', out_signature='')
    ...
    @dbus.service.method('org.freedesktop.Telepathy.Call1.Content.Interface.DTMF', in_signature='', out_signature='')
    def StopTone(self):
        """
    ...
    @dbus.service.method('org.freedesktop.Telepathy.Call1.Content.Interface.DTMF', in_signature='s', out_signature='')
    ...
    @dbus.service.signal('org.freedesktop.Telepathy.Call1.Content.Interface.DTMF', signature='s')
    ...
    @dbus.service.signal('org.freedesktop.Telepathy.Call1.Content.Interface.DTMF', signature='b')
